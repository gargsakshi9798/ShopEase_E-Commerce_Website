...
const ElectronicsProductDetail = () => {
  ...
  const product = electronicsProducts.find((p) => p._id === id);
  ...
  if (!product) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4">
        ...
        <Link to="/electronics" className="text-primary-600 font-semibold hover:underline">← Back to Electronics</Link>
      </div>
    );
  }
  ...
  const cheaper = electronicsProducts.filter((p) => p._id !== product._id && p.price <= product.price * 0.9).slice(0, 6);
  const quality = electronicsProducts.filter((p) => p._id !== product._id && p.rating >= 4.4).slice(0, 6);
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-[1280px] mx-auto px-4 py-3">
        <nav className="flex items-center gap-1.5 text-xs text-gray-500">
          ...
          <span>/</span>
          <Link to="/electronics" className="hover:text-primary-600">Electronics</Link>
          <span>/</span>
      ...
      <div className="max-w-[1280px] mx-auto px-4 pb-6">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 min-w-0 space-y-4">
            ...
            {/* Size — "One Size" badge only */}
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
              <p className="text-sm font-bold text-gray-800 mb-2">Variant</p>
              <span className="inline-flex items-center px-3 py-1.5 bg-gray-100 text-gray-600 text-sm font-semibold rounded-xl">
                One Size
              </span>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
              ...
              <div className="mt-4 grid grid-cols-3 gap-3">
                ...
                <div className="flex flex-col items-center text-center gap-1">
                  ...
                  <p className="text-[11px] font-semibold text-gray-700">Warranty</p>
        ...
        {cheaper.length > 0 && (
          <div className="mt-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/electronics" className="text-sm text-primary-600 font-semibold hover:underline">View All</Link>
            </div>
